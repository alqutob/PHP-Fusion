...
echo openform('smiley_form', 'smiley_form', 'post', $form_action, ['downtime' => 0]);
echo "<table cellpadding='0' cellspacing='0' class='table table-responsive center'>\n<tbody>\n<tr>\n";
echo "<td class='tbl'><label for='smiley_code'>".$locale['420']."</label></td>\n";
echo "<td class='tbl'>\n";
echo form_text('', 'smiley_code', 'smiley_code', $smiley_code, ['required' => 1, 'error_text' => $locale['438']]);
echo "</td>\n</tr>\n<tr>\n";
echo "<td class='tbl'><label for='smiley_image'>".$locale['421']."</label> <span class='required'>*</span></td>\n";
echo "<td class='tbl'>\n";
echo form_select('', 'smiley_image', 'smiley_image', $smiley_opts, $smiley_image, ['placeholder' => $locale['choose'],
                                                                                   'required'    => 1,
...
echo "<td class='tbl'>\n";
echo form_text('', 'smiley_text', 'smiley_text', $smiley_text, ['required' => 1, 'error_text' => $locale['439']]);
echo "</td>\n<tr>\n<td align='center' colspan='2' class='tbl'><br />\n";
echo form_button($locale['423'], 'save_smiley', 'save_smiley', $locale['423'], ['class' => 'btn-primary']);
echo "</td>\n</tr>\n</tbody>\n</table>\n";
echo closeform();
