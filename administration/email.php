...
echo openform('emailtemplateform', 'emailtemplateform', 'post', FUSION_SELF.$aidlink, ['downtime' => 0]);
...
echo "<td class='tbl1'>\n";
echo form_text('', 'template_sender_name', 'template_sender_name', $template_sender_name, ['required'   => 1,
...
echo "<td class='tbl1'>\n";
echo form_text('', 'template_sender_email', 'template_sender_email', $template_sender_email, ['required'   => 1,
...
if (multilang_table("ET")) {
    ...
    echo "<td class='tbl'>\n";
    echo form_select('', 'template_language', 'template_language', $language_opts, $template_language, ['placeholder' => $locale['choose']]);
    echo "</td>\n</tr>\n";
} else {
