...
if (isset($_GET['action']) && $_GET['action'] == "refresh") {
    ...
    echo "<td class='tbl'>\n";
    echo form_text('', 'cat_name', 'cat_name', $cat_name, ['required' => 1, 'error_text' => $locale['450a']]);
    echo "</td>\n</tr>\n<tr>\n";
    ...
    echo "<td class='tbl'>\n";
    echo form_text('', 'cat_order', 'cat_order', $cat_order, ['number' => 1, 'width' => '100px']);
    echo "</tr>\n<tr>\n";
    ...
    echo form_button($locale['422'], 'savecat', 'savecat', $locale['422'], ['class' => 'btn-primary']);
    echo "</td>\n</tr>\n</tbody>\n</table>\n</form>\n";
    closetable();
