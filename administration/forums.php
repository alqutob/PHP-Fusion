...
if (!isset($_GET['t']) || $_GET['t'] != "forum") {
    ...
    echo "<td class='tbl'>\n";
    echo form_text($locale['420'], 'cat_name', 'cat_name', $cat_name, ['required'   => 1,
                                                                       'error_text' => $locale['516']]);
    echo "</td>\n";
    if (!isset($_GET['action']) || $_GET['action'] != "edit") {
        echo "<td width='150' class='tbl'>";
        echo form_text($locale['421'], 'cat_order', 'cat_order', $cat_order, ['number' => 1]);
        echo "</td>\n";
    }
    echo "</tr>\n";
    if (multilang_table("FO")) {
        echo "<tr><td class='tbl' colspan='2'>\n";
        echo form_select($locale['global_ML100'], 'forum_language', 'forum_language', $language_opts, $forum_language, ['placeholder' => $locale['choose']]);
    ...
    echo form_button($locale['422'], 'save_cat', 'save_cat', $locale['422'], ['class' => 'btn-primary']);
    echo "</td>\n";
    echo "</tr>\n</table>\n</form>\n";
    closetable();
}
if (!isset($_GET['t']) || $_GET['t'] != "cat") {
    ...
    if (dbrows($result2)) {
        ...
        echo openform('addforum', 'addforum', 'post', $forum_action, ['downtime' => 0, 'notice' => 0]);
        echo "<table cellpadding='0' cellspacing='0' class='table table-responsive'>\n<tr>\n";
        echo "<td colspan='2' class='tbl'>\n";
        echo form_text($locale['520'], 'forum_name', 'forum_name', $forum_name, ['required'   => 1,
                                                                                 'error_text' => $locale['517']]);
        echo "</td>\n";
        echo "</tr>\n";
        if (multilang_table("FO")) {
            echo "<tr><td class='tbl' colspan='2'>\n";
            echo form_select($locale['global_ML100'], 'forum_language_2', 'forum_language_2', $language_opts, $forum_language, ['placeholder' => $locale['choose']]);
            echo "</td>\n";
            echo "</tr>\n";
        } else {
        ...
        echo "</tr>\n<tr>\n";
        echo "<td class='tbl'>\n";
        echo form_select($locale['522'], 'forum_cat', 'forum_cat', $cat_opts, $forum_cat, ['placeholder' => $locale['choose']]);
        echo "</td>\n<td width='25%' class='tbl'>\n";
        if (!isset($_GET['action']) || $_GET['action'] != "edit") {
            echo form_text($locale['523'], 'forum_order', 'forum_order', $forum_order, ['number' => 1,
                                                                                        'inline' => 1]);
            echo "</td>\n</tr>\n<tr>\n";
            echo "<td align='center' colspan='2' class='tbl'>\n";
            echo form_button($locale['532'], 'save_forum', 'save_forum', $locale['532'], ['class' => 'btn-primary']);
        }
        echo "</td>\n</tr>\n</table>\n";
        if (isset($_GET['action']) && $_GET['action'] == "edit") {
            echo "<table align='center' cellpadding='0' cellspacing='0' class='table table-responsive'>\n<tr>\n";
            ...
            echo "<td class='tbl'>\n";
            echo form_select('', 'forum_access', 'forum_access', $access_opts, $forum_access, ['placeholder' => $locale['choose']]);
            echo "</td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td width='1%' class='tbl' style='white-space:nowrap'><label for='forum_post'>".$locale['526']."</label></td>\n<td class='tbl'>\n";
            echo form_select('', 'forum_post', 'forum_post', $access_opts, $forum_post, ['placeholder' => $locale['choose']]);
            echo "</td>\n</tr>\n<tr>\n";
            echo "<td width='1%' class='tbl' style='white-space:nowrap'><label for='forum_reply'>".$locale['527']."</label></td>\n<td class='tbl'>\n";
            echo form_select('', 'forum_reply', 'forum_reply', $access_opts, $forum_reply, ['placeholder' => $locale['choose']]);
            echo "</td>\n</tr>\n<tr>\n";
            echo "<td width='1%' class='tbl' style='white-space:nowrap'><label for='forum_attach'>".$locale['528']."</label></td>\n<td class='tbl'>\n";
            echo form_select('', 'forum_attach', 'forum_attach', $access_opts, $forum_attach, ['placeholder' => $locale['choose']]);
            echo "</td>\n</tr>\n<tr>\n";
            echo "<td width='1%' class='tbl' style='white-space:nowrap'><label for='forum_attach_download'>".$locale['535']."</label></td>\n<td class='tbl'>\n";
            echo form_select('', 'forum_attach_download', 'forum_attach_download', $access_opts, $forum_attach_download, ['placeholder' => $locale['choose']]);
            echo "</td>\n</tr>\n<tr>\n";
            echo "<td width='1%' class='tbl' style='white-space:nowrap'><label for='forum_poll'>".$locale['529']."</label></td>\n<td class='tbl'>\n";
            echo form_select('', 'forum_poll', 'forum_poll', $access_opts, $forum_poll, ['placeholder' => $locale['choose']]);
            echo "</td>\n</tr>\n<tr>\n";
            echo "<td width='1%' class='tbl' style='white-space:nowrap'><label for='forum_vote'>".$locale['530']."</label></td>\n<td class='tbl'>\n";
            echo form_select('', 'forum_vote', 'forum_vote', $access_opts, $forum_poll, ['placeholder' => $locale['choose']]);
            echo "</tr>\n<tr>\n";
            ...
            $array = ['1' => $locale['542'], '0' => $locale['543']];
            echo form_select('', 'forum_merge', 'forum_merge', $array, $forum_merge, ['placeholder' => $locale['choose']]);
            echo "</td>\n</tr>\n";
            if (!isset($_GET['action']) || $_GET['action'] != "edit") {
        ...
        if (isset($_GET['action']) && $_GET['action'] == "edit") {
            ...
            echo form_button($locale['532'], 'save', 'save', $locale['532'], ['class' => 'btn-primary']);
            add_to_jquery("
