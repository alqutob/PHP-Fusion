...
if ((isset($_GET['action']) && $_GET['action'] == "delete") && (isset($_GET['blacklist_id']) && isnum($_GET['blacklist_id']))) {
    ...
    echo $locale['440'];
    echo "</div>\n";
    echo openform('blacklist_form', 'blacklist_form', 'post', $form_action, ['downtime' => 0]);
    ...
    echo "<td class='tbl'>\n";
    echo form_text('', 'blacklist_email', 'blacklist_email', $blacklist_email, ['email'      => 1,
    ...
    echo form_button($locale['444'], 'blacklist_user', 'blacklist_user', $locale['444'], ['class' => 'btn-primary']);
    echo "</td>\n</tr>\n</tbody>\n</table>\n</form>\n";
    closetable();
