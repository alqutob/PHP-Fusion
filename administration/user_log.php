...
$user = "";
$userField = "";
$orderbyArray = [$locale['102'] => "userlog_timestamp", $locale['103'] => "user_name",
...
// change to post.
echo openform('userlog_search', 'userlog_search', 'post', FUSION_SELF.$aidlink, ['downtime' => 0]);
...
echo form_select('', 'orderby', 'orderby', orderbyOptions(), $orderby, ['placholder' => $locale['choose'],
                                                                        'class'      => 'pull-right m-r-10']);
echo form_select('', 'expr', 'expr', exprOptions(), $orderby, ['placholder' => $locale['choose']]);
echo "</td>\n</tr>\n<tr>\n";
...
echo "<td class='tbl1'>\n";
echo form_select('', 'userField', 'userField', userFieldOptions(), $userField, ['placeholder' => $locale['choose'],
                                                                                'allowclear'  => 1]);
echo "</tr>\n<tr>\n";
echo "<td class='tbl' align='left'></td>\n<td class='tbl' align='right'>\n";
echo form_button($locale['109'], 'submit', 'submit', $locale['109'], ['class' => 'btn-primary']);
echo "</td>\n</tr>\n</tbody>\n</table>\n</form>\n";
echo "<br />";
...
echo "<td class='tbl1' align='right'>\n";
echo form_text('', 'delete', 'delete', '', ['max_length' => 3, 'number' => 1, 'placeholder' => $locale['111'],
