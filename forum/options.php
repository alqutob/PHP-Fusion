...
if (isset($_GET['step']) && $_GET['step'] == "renew") {
    ...
    if (isset($_POST['move_thread'])) {
        ...
        echo form_hidden($locale['451'], 'new_forum_id', 'new_forum_id', '', ['title' => 1, 'inline' => 1]);
        echo form_button($locale['450'], 'move_thread', 'move_thread', $locale['450'], ['class' => 'btn-primary flright pull-right col-sm-offset-3 col-md-offset-3 col-lg-offset-3']);
        echo "</div>\n</div\n";
        echo closeform();
    }
    closetable();
