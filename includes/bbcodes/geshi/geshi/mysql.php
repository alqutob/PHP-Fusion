 ...
 ************************************************************************************/
$language_data = ['LANG_NAME'              => 'MySQL',
                  //'COMMENT_SINGLE' => array(1 =>'--', 2 => '#'),    // '--' MUST be folowed by whitespace,not necessarily a space
                  'COMMENT_SINGLE'         => [1 => '-- ', 2 => '#'],
                  'COMMENT_REGEXP'         => [1 => "/(?:--\s).*?$/", // double dash followed by any whitespace
                  ], 'COMMENT_MULTI'       => ['/*' => '*/'], 'CASE_KEYWORDS' => GESHI_CAPS_NO_CHANGE,
                  // @@@ would be nice if this could be defined per group!
                  'QUOTEMARKS'             => ["'", '"', '`'], 'ESCAPE_CHAR' => '\\', // by default only, can be specified
                  'ESCAPE_REGEXP'          => [1 => "/[_%]/", // search wildcards
                  ],
                  ...
                  'KEYWORDS'               => [1 => [// Mix: statement keywords and keywords that don't fit in any other
                                                     ...
                                                     'WRITE',], 2 => [ //No ( must follow
                                                                       ...
                                                                       "TRUNCATE"],
                                               3 => [// Values (Constants)
                                                     'FALSE', 'NULL', 'TRUE',], 4 => [// Column Data Types
                                                                                      'BIGINT', 'BIT', 'BLOB',
                                                                                      'BOOLEAN', 'BOOL',
                                                                                      'CHARACTER VARYING',
                                               ...
                                               5 => [ //No ( must follow
                                                      ...
                                                      "CHAR", "DATE", "TIME"],
                                               6 => [// Table, Column & Index Attributes
                                               ...
                                               11 => [ //No ( must follow
                                                       ...
                                                       "INTERVAL"], 12 => [// Control Flow (functions)
                                               ...
                                               13 => [// String Functions
                                                      ...
                                                      'UCASE', 'UNHEX', 'UPPER',], 14 => [ //A ( must follow
                                               ...
                                               16 => [ //A ( must follow
                                                       ...
                                                       "TRUNCATE"], 17 => [// Date and Time Functions
                                               ...
                                               21 => [// Encryption and Compression Functions
                                                      ...
                                                      'UNCOMPRESSED_LENGTH',],
                                               22 => [// GROUP BY (aggregate) Functions
                  ...
                  'SYMBOLS'                => [1 => [/* Operators */
                                                     ...
                                                     '|', '&', '^', '~', '<<', '>>', // bitwise operators
                                                     '-', '+', '*', '/', '%', // numerical operators
                  ], 2                           => [/* Other syntactical symbols */
                                                     '(', ')', ',', ';',],],
                  'CASE_SENSITIVE'         => [GESHI_COMMENTS => FALSE, 1 => FALSE, 2 => FALSE, 3 => FALSE,
                  ...
                  'STYLES'                 => ['KEYWORDS'    => [1  => 'color: #990099; font-weight: bold;', // mix
                  ...
                  ], 'COMMENTS'                              => ['MULTI' => 'color: #808000; font-style: italic;',
                                                                 1       => 'color: #808080; font-style: italic;',
                                                                 2       => 'color: #808080; font-style: italic;'],
                                               'ESCAPE_CHAR' => [0 => 'color: #004000; font-weight: bold;',
                                                                 1 => 'color: #008080; font-weight: bold;'
                                                                 // search wildcards
                                               ], 'BRACKETS' => [0 => 'color: #FF00FF;'],
                                               'STRINGS'     => [0 => 'color: #008000;'],
                                               'NUMBERS'     => [0 => 'color: #008080;'], 'METHODS' => [],
                                               'SYMBOLS'     => [1 => 'color: #CC0099;', // operators
                                                                 2 => 'color: #000033;', // syntax
                                               ], 'SCRIPT'   => [], 'REGEXPS' => []],
                  'URLS'                   => [1  => 'http://search.mysql.com/search?site=refman-%35%31&amp;q={FNAME}',
                  ...
                  'OOLANG'                 => FALSE, 'OBJECT_SPLITTERS' => [], 'REGEXPS' => [],
                  'STRICT_MODE_APPLIES'    => GESHI_NEVER, 'SCRIPT_DELIMITERS' => [],
                  'HIGHLIGHT_STRICT_BLOCK' => [], 'TAB_WIDTH' => 4,
                  'PARSER_CONTROL'         => ['KEYWORDS' => [2  => ['DISALLOWED_AFTER' => '(?![\(\w])'],
                                                              5  => ['DISALLOWED_AFTER' => '(?![\(\w])'],
                                                              7  => ['DISALLOWED_AFTER' => '(?![\(\w])'],
                                                              9  => ['DISALLOWED_AFTER' => '(?![\(\w])'],
                                                              11 => ['DISALLOWED_AFTER' => '(?![\(\w])'],
                                                              14 => ['DISALLOWED_AFTER' => '(?=\()'],
                                                              16 => ['DISALLOWED_AFTER' => '(?=\()'],
                                                              18 => ['DISALLOWED_AFTER' => '(?=\()'],
                                                              20 => ['DISALLOWED_AFTER' => '(?=\()'],
