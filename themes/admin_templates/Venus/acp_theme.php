...
$admin_password = '';
	...
	if (!check_admin_pass($admin_password) && !stristr($_SERVER['PHP_SELF'], $settings['site_path']."infusions")) {
		...
		echo "<div id='acp-main' class='display-block acp ".(isset($_COOKIE['Venus']) && $_COOKIE['Venus'] ? 'in' : '')."' style='width:100%; height:100%; vertical-align:top;'>\n";
		echo "<div id='acp-toolkit' class='hidden-xs hidden-sm col-md-12 col-lg-12 m-b-10 m-r-0' style='width:100%;margin-top:50px' role='toolkits'>\n";
